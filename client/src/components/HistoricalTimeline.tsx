        ...
        return (
          <Card key={idx} className="overflow-hidden" data-testid={`timeline-item-${idx}`}>
            <button
              ...
              className="w-full p-3 flex items-center justify-between hover-elevate active-elevate-2 text-left"
              data-testid={`button-expand-timeline-${idx}`}
            >
              <div className="flex items-center gap-3">
                <div className="flex flex-col">
                  <span className="text-xs font-semibold">{rec.date}</span>
                ...
                <Badge
                  variant="secondary"
                  className={`text-[10px] px-1.5 py-0 ${avgPerformance >= 0 ? "bg-[hsl(142_71%_45%)]/20 text-[hsl(142_71%_45%)]" : "bg-[hsl(0_72%_51%)]/20 text-[hsl(0_72%_51%)]"}`}
                >
                ...
                <div className="p-3 space-y-2">
                  {rec.stocks.map((stock, stockIdx) => (
                    ...
                    >
                      ...
                      <Badge
                        variant="secondary"
                        className={`font-mono tabular-nums text-[10px] px-1.5 py-0 ${stock.performance >= 0 ? "bg-[hsl(142_71%_45%)]/20 text-[hsl(142_71%_45%)]" : "bg-[hsl(0_72%_51%)]/20 text-[hsl(0_72%_51%)]"}`}
                      >
